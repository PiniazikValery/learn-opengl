...
void Shader::set4f(const std::string &name, const std::vector<float> &vec4f) const
{
    glUniform4f(glGetUniformLocation(ID, name.c_str()), vec4f[0], vec4f[1], vec4f[2], vec4f[3]);
}
